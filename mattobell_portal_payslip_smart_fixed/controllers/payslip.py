...
class PortalPayslip(http.Controller):
    ...
    def list(self, **kw):
        ...
        if not emp:
            return request.render("mattobell_portal_payslip_smart_fixed.no_employee")
        ...
        return request.render("mattobell_portal_payslip_smart_fixed.page",{"payslips":slips,"atts":atts})
    ...
    def dl(self, sid, **kw):
        ...
        if not slip.exists() or not self._allowed(slip):
            return request.render("mattobell_portal_payslip_smart_fixed.denied")
